        ...
        <div>
            ...
            <div class="bg-[#F0F2F5] py-4">
              <div class="container flex justify-between max-w-5xl mx-auto">
                ...
                <div class="flex items-center space-x-4">
                  <div>
                    <img src="/images/moneyBack.png" alt="moneyBackGuarantee" class="h-14">
                  </div>
                  <div>
                    <div class="-space-y-1">
              ...
              <div class="container flex justify-between max-w-6xl mx-auto h-[16rem]">
                <div class="bg-[#F0F2F5] flex justify-between items-center rounded-lg  p-8 w-full mr-4 h-full">
                  <div class="max-w-[50%]">
                    ...
                    <p class="">
                      Short description of the most popular category, Short description of the most popular category, Short description of the most popular category.
                    </p>
                  </div>
                  <div class="flex items-center">
                    <img src="/images/moneyBack.png" alt="hihi" class="h-40">
                  </div>
                </div>
                <div class="w-full">
                  <div class="bg-[#F0F2F5] justify-between items-center flex rounded-lg h-[7.5rem] p-8 mb-4">
                    <div class="max-w-[50%]">
                      ...
                      <p class="">
                        Short description of the most popular category
                      </p>
                    </div>
                    <div class="flex items-center">
                      <img src="/images/moneyBack.png" alt="hihi" class="h-28">
                    </div>
                  </div>
           ...
           <div class="pb-8">
            <div>
              <h3 class="pt-24 pb-8 text-3xl font-bold text-center">
                Discover our blog
              </h3>
            </div>
            <div>
              <div class="container flex max-w-6xl mx-auto space-x-4">
                <div>
                  ...
                  <h3 class="py-4 text-lg font-bold">
                    See how someone made more money, lost weight, saved time while using your product
                  </h3>
                  <p class="pb-4"> 
                    Showcase a powerful testimonial from a satisfied customer that highlights the product's key benefit and encourages others to make a purchase...
                  </p>
